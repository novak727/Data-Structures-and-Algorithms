...
//---------------------------------------------------------------------------
/* unorderedLinkedList
* A templated linked list of items.
* Methods available to search the list, insert items at the beginning and end
* of the list, and delete items from the list.
*/
template <class Type>
...
//---------------------------------------------------------------------------
/* search() takes a parameter and determines whether or not the parameter is
* in the list, returning either true or false.
*/
template <class Type>
...
//---------------------------------------------------------------------------
/* insertFirst() takes a parameter and inserts it at the beginning of the
* linked list
*/
template <class Type>
void unorderedLinkedList<Type>::insertFirst(const Type& newItem)
{
    ...
    if (linkedListType<Type>::last == nullptr)   // if the list was empty, newNode is also
                        // the last node in the list
        linkedListType<Type>::last = newNode;
} // end insertFirst

//---------------------------------------------------------------------------
/* insertLast() takes a parameter and inserts its value at the end of the
* linked list.
*/
template <class Type>
...
//---------------------------------------------------------------------------
/* deleteNode() takes a parameter, finds the item, and deletes the item from
* the linked list.
*/
template <class Type>
